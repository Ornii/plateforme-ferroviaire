...
\usepackage[left=1cm, right=1cm, top=0.75cm, bottom=0.75cm]{geometry}
...
\begin{document}
	...
	\begin{center}
		\resizebox{0.85\columnwidth}{!}{%
			...
			\node[bluenode] (1) at (-2,1) {C2(A1)};
			\node[orangenode] (2) at (2,1) {C4(A2)};
			\node[darkbluenode] (3) at (0,0) {C3};
			\node[lightgreennode] (4) at (-2,-1) {C5};
			\node[yellownode] (5) at (2,-1) {C6};
			\node[greennode] (6) at (-1,-2.5) {C7(A3)};
			\node[greenishyellownode] (7) at (1,-2.5) {C8(A4)};
			\node[rednode] (8) at (0,-4) {C9};
			...
			\draw[-stealth,very thick](8) to[bend left] (6);
			\draw[-stealth,very thick](7) to[bend left] (8);
		\end{tikzpicture}
	}
	\end{center}
	...
	\begin{blockarray}{cccccccccc}
		& \text{C1} & \text{C2} & \text{C3} & \text{C4} & \text{C5} & \text{C6} & \text{C7} & \text{C8} & \text{C9}\\
		\begin{block}{c(ccccccccc)}
			\text{C1} & 0 & 0 & 0 & 1 & 0 & 0 & 0 & 0 & 0 \\
			\text{C2} & 1 & 0 & 0 & 0 & 0 & 0 & 0 & 0 & 0 \\
			\text{C3} & 0 & 1 & 0 & 0 & 0 & 0 & 0 & 0 & 0 \\
			\text{C4} & 0 & 0 & 1 & 0 & 0 & 1 & 0 & 0 & 0 \\
			\text{C5} & 0 & 1 & 0 & 0 & 0 & 0 & 0 & 0 & 0 \\
			\text{C6} & 0 & 0 & 0 & 0 & 0 & 0 & 0 & 1 & 0 \\
			\text{C7} & 0 & 0 & 0 & 0 & 1 & 0 & 0 & 0 & 1 \\
			\text{C8} & 0 & 0 & 0 & 0 & 0 & 0 & 1 & 0 & 0 \\
			\text{C9} & 0 & 0 & 0 & 0 & 0 & 0 & 0 & 1 & 0 \\
		\end{block}
	\end{blockarray}
	$$
	\section*{Sur Python}		
