...
class Circuit:
    ...
    def get_all_structures(self):
        ...
        for id, canton in self.cantons.canton_by_id.items():
            self.structure_by_id[id] = canton
        for id, terminal in self.terminaux.terminal_by_id.items():
            self.structure_by_id[id] = terminal
        for id, aiguillage in self.aiguillages.aiguillage_by_id.items():
            self.structure_by_id[id] = aiguillage
        for (
            id,
            aiguillage_triple,
        ) in self.aiguillages_triple.aiguillage_triple_by_id.items():
            self.structure_by_id[id] = aiguillage_triple
        for (
            id,
            croisement_avec_aiguille,
        ) in self.croisements_avec_aiguille.croisement_avec_aiguille_by_id.items():
            self.structure_by_id[id] = croisement_avec_aiguille
        for (
            id,
            croisement_sans_aiguille,
        ) in self.croisements_sans_aiguille.croisement_sans_aiguille_by_id.items():
            self.structure_by_id[id] = croisement_sans_aiguille
...
class Canton:
    ...
    def detect_train(self, next_structure: Structure):
        pass
